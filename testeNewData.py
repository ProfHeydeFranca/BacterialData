...
dados_bacterias['Best assembly'] = dados_bacterias.index
dados_genomas['Best assembly'] = dados_genomas.index

#Merge data with exact match
dados_bacterias_merged = dados_bacteriass.merge(dados_genomas, left_index=True, right_index=True, how='outer')
...
dados_bacterias_merged.to_csv('dados_bacterias_com_genomas_merge.csv', index=False)
